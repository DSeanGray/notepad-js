(function() {
  ...
  assert.isEqual(view.displayPage(), "<ul><li><div id='0'>Favourite food: pest</div></li><li><div id='1'>Favourite drink: sel</div></li></ul>");
...
(function(){
  var list = new listOfNotes();
  var view = new noteListView(list);
  var response = "<ul><li><div id='0'>Bikes: Decent road o</div></li></ul>";
